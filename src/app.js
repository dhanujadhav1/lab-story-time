...
function moreAboutHome(address, distanceFromTown, hasNeighbours) {
    var valu = typeof (address) + typeof (distanceFromTown) + typeof (hasNeighbours);
...
function sweetTooth(totalNoOfSweets, sweetsConsumedByKaren, sweetsConsumedInNMeters, metersToTravel) {
    ...
    if (totalNoOfSweets == undefined && sweetsConsumedByKaren == undefined && sweetsConsumedInNMeters == undefined && metersToTravel == undefined)
...
function convertToCelsius(fahrenheit) {
    if (fahrenheit == undefined || typeof (fahrenheit) == "string" || typeof (fahrenheit) == "object")
